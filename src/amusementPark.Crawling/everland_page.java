...
public class everland_page {
	...
	public static void main(String[] args) throws IOException {
		File fileSave = new File ("C:\\Users\\IM\\Desktop\\javaBasicPrj\\amusementPark\\everland.csv"); // 파일 저장 경로 지정 및 파일 생성
		...
		// 검색창에 검색어 입력
		driver.findElement(By.xpath("/html/body/div[2]/div[2]/div[1]/div/div[3]/form/fieldset/div/input")).sendKeys("에버랜드");	 	//검색창에 에버랜드 입력
